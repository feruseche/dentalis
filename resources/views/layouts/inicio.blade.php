          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="historias.historia"><i class="fa fa-circle-o"></i> Pacientes</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="odontologos.index"><i class="fa fa-circle-o"></i> Odontólogos</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="servicios.index"><i class="fa fa-circle-o"></i> Tratamientos</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="vademecum.index"><i class="fa fa-circle-o"></i> Medicamentos</a></li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="citas.sms_pacientes"><i class="fa fa-circle-o"></i> SMS a Pacientes</a></li>
